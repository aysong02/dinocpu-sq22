...
class ALUControlUnitBTypeTester(c: ALUControl) extends PeekPokeTester(c) {
  ...
  val tests = List(
    ...
    //(  false.B, false.B, "b0000000".U, "b000".U, "b0111".U, "load/store"),
    (  true.B,  false.B, "b0000000".U, "b000".U, "b0110".U, "add"),
    (  true.B,  false.B, "b0100000".U, "b000".U, "b0100".U, "sub"),
    (  true.B,  false.B, "b0000000".U, "b001".U, "b1001".U, "sll"),
    (  true.B,  false.B, "b0000000".U, "b010".U, "b1000".U, "slt"),
    ...
    (  true.B,  false.B, "b0000000".U, "b111".U, "b0111".U, "and"),
    (  true.B,  true.B,  "b0000000".U, "b000".U, "b0110".U, "addi"),
    (  true.B,  true.B,  "b0000000".U, "b010".U, "b1000".U, "slti"),
    ...
    (  true.B,  true.B,  "b0000000".U, "b111".U, "b0111".U, "andi"),
    (  true.B,  true.B,  "b0000000".U, "b001".U, "b1001".U, "slli"),
